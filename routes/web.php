...
Route::controller(AuthController::class)->group(function () {
    ...
    // Employee Position
    Route::get('employee_position','employee_position')->name('employee_position');
    Route::get('position_details','position_details')->name('position_details');
    Route::post('positionSave','positionSave')->name('positionSave');
